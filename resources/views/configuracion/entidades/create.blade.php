...
<div class="max-w-5xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">
            Registre una nueva entidad pública.
        </p>
    ...
    <div class="bg-white rounded-lg shadow border border-gray-200">
        ...
        <form action="{{ route('configuracion.entidades.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="Organismo Rector" {{ old('tipo')=='Organismo Rector' ? 'selected' : '' }}>
                            Organismo Rector
                        </option>

                        <option value="Ministerio" {{ old('tipo')=='Ministerio' ? 'selected' : '' }}>
                            Ministerio
                        </option>
